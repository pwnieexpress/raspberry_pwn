...
2. The Debian Raspberry Pi distribution (installed onto SD card)
...
5. Download the latest Raspberry Pwn installer from the Pwnie Express Github repository:

  # git

  # tar zxvf raspberry-pwn-0.1.tar.gz

  # cd raspberry-pwn-0.1
